...
class DenseNet121(nn.Module):
    ...
    def __init__(self, out_size, mode, drop_rate=0):
        ...
        self.projection_layer = nn.Linear(num_ftrs, 128)
        nn.init.constant_(self.feature_layer.bias, 1)
    ...
    def forward(self, x):
        ...
        if self.mode in ('U-Ones', 'U-Zeros'):
            out = self.densenet121.classifier(feature)
        ...
        return self.activations, projection, feature, out
