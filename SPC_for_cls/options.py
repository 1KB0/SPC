...
def args_parser():
    ...
    parser.add_argument('--root_path', type=str, default='/datasets/ChestXRay2017/chestxray', help='dataset root dir')
    parser.add_argument('--csv_path', type=str, default='/datasets/1339', help='dataset csv dir')
    ...
    parser.add_argument('--num_users', type=int,  default=10, help='num_users')
