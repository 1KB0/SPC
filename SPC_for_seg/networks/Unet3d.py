...
class BaselineUNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x1 = self.block_3_2_right(self.block_3_1_right(torch.cat([self.upconv_3(x), ds2], 1)))
        x2 = self.block_2_2_right(self.block_2_1_right(torch.cat([self.upconv_2(x1), ds1], 1)))
        x3 = self.block_1_2_right(self.block_1_1_right(torch.cat([self.upconv_1(x2), ds0], 1)))
